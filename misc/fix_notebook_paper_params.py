...
def fix_notebook():
    ...
    if sim_cell_idx != -1 and sim_cell_idx < len(nb.cells):
        ...
        # Update simulation code with explicit PAPER parameters
        nb.cells[sim_cell_idx].source = """# System parameters (Shatnawi et al. 2023)
# gamma=-0.2, theta=0.108, delta=0.08, I_ext=2.0
# k1=-0.06, k2=0.2
params = {
    'gamma': -0.2,
    'theta': 0.108,
...
print(f"Simulating memristive FHN system with Paper Parameters...")
...
axes[0].set_title('Memristive FHN Neuron Dynamics (Paper Parameters)', fontsize=13, fontweight='bold')
